...
qwen3_5_training_chat_template_2b_and_below = (
    _CHAT_TEMPLATES_DIR / "qwen3_5_2b_and_below_training.jinja"
).read_text()

qwen3_5_training_chat_template_4b_and_above = (
    _CHAT_TEMPLATES_DIR / "qwen3_5_4b_and_above_training.jinja"
).read_text()
...
def get_training_chat_template(
    ...
    if processing_class.chat_template == qwen3_5_chat_template_2b_and_below:
        return qwen3_5_training_chat_template_2b_and_below

    if processing_class.chat_template == qwen3_5_chat_template_4b_and_above:
